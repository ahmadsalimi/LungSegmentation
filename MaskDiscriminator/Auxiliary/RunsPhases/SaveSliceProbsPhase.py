...
class SaveSliceProbsPhase(Phase):

    def __init__(self, conf, model):
        super(SaveSliceProbsPhase, self).__init__('savesliceprobs', conf, model)
    ...
    def run_subclass(self):
        ...
        for test_group_info in self.conf['samples_dir'].split(','):
            try:
                ...
                evaluator.create_report_for_sample_elements(self.conf['report_dir'])
