...
from Models.MaskDiscriminatorModels.models import AttentionMaskDiscriminator
...
def get_configs():
    ...
    n_conf = {
        ...
        'batch_size': 1,
        'try_num': 1,
        'try_name': 'AttentionMaskDiscriminator',
        'max_epochs': 100,
        'dataSeparationDir': '../',
...
if __name__ == '__main__':
    ...
    model = AttentionMaskDiscriminator(the_conf['batch_norms'])
